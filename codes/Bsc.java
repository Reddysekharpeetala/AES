...
public class Bsc extends JFrame implements ActionListener
{
	...
	void updateSubjects() 
	{
        	...
        	if (semester >=0) 
		{
            		...
            		programList.setListData(bscSubjects[semester]);
        	}
    	}
    	...
    	public void actionPerformed(ActionEvent e) 
	{
		...
		else if(source==okButton) 
		{
            	...
            	List<String> selectedProgram=List.of(bscSubjects[semester-1]);
