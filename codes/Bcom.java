...
public class Bcom extends JFrame implements ActionListener 
{
    ...
    String[][] bcomSubjects = {
            ...
            {"Corporate Accounting", "Banking & Insurance"},
            {"Income Tax", "Auditing"},
    ...
    void updateSubjects() 
    {
        ...
        if (semester >= 0) 
        {
            ...
            programList.setListData(bcomSubjects[semester]);
        }
    }
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        else if (source == okButton) 
        {
            ...
            List<String> selectedProgram = List.of(bcomSubjects[semester - 1]);

            if (storeInDatabase(program, semester, selectedCommon, selectedProgram)) 
            {
                JOptionPane.showMessageDialog(this,
                        "Data stored successfully for " + program + " Semester " + semester);
                dispose(); 
                new studentdetails(); 
            } 
            else 
