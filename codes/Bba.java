...
public class Bba extends JFrame implements ActionListener 
{
    ...
    String[][] bbaSubjects = {
            ...
            {"Financial Management", "Entrepreneurship Development"},
            {"Project Work"}
    };
    ...
    void updateSubjects() 
    {
        ...
        if (semester >= 0) 
        {
            ...
            programList.setListData(bbaSubjects[semester]);
        }
    }
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        else if (source == okButton) 
        {
            ...
            List<String> selectedProgram = List.of(bbaSubjects[semester - 1]);
